...
:if ([:len [find name="iads.unity3d.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="dnsfwd:auto:category-dev@ads" match-subdomain=yes type=FWD name="iads.unity3d.com" }
