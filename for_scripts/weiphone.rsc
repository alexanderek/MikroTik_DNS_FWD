...
:if ([:len [find name="weiphone.net"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="dnsfwd:auto:weiphone" match-subdomain=yes type=FWD name="weiphone.net" }
