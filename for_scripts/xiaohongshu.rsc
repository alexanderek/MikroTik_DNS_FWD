...
:if ([:len [find name="rednotecdn.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="dnsfwd:auto:xiaohongshu" match-subdomain=yes type=FWD name="rednotecdn.com" }
...
:if ([:len [find name="xhsrcdn.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="dnsfwd:auto:xiaohongshu" match-subdomain=yes type=FWD name="xhsrcdn.com" }
