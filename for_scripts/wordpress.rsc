...
:if ([:len [find name="wordpress.net"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="dnsfwd:auto:wordpress" match-subdomain=yes type=FWD name="wordpress.net" }
