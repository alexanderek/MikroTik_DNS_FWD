...
:if ([:len [find name="rockstarnorth.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="dnsfwd:auto:rockstar" match-subdomain=yes type=FWD name="rockstarnorth.com" }
