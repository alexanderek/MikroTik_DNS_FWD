...
:if ([:len [find name="djigate.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="dnsfwd:auto:dji" match-subdomain=yes type=FWD name="djigate.com" }
