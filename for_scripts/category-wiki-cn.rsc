...
:global ForwardTo
/ip dns static
:if ([:len [find name="allhistory.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="dnsfwd:auto:category-wiki-cn" match-subdomain=yes type=FWD name="allhistory.com" }
:if ([:len [find name="chaz.fun"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="dnsfwd:auto:category-wiki-cn" match-subdomain=yes type=FWD name="chaz.fun" }
