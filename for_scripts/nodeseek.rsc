...
:if ([:len [find name="nodeget.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="dnsfwd:auto:nodeseek" match-subdomain=yes type=FWD name="nodeget.com" }
