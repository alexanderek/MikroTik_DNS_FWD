...
:if ([:len [find name="codeium.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="dnsfwd:auto:category-ai-chat-!cn" match-subdomain=yes type=FWD name="codeium.com" }
:if ([:len [find name="codeiumdata.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="dnsfwd:auto:category-ai-chat-!cn" match-subdomain=yes type=FWD name="codeiumdata.com" }
...
:if ([:len [find name="ppl-ai-file-upload.s3.amazonaws.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="dnsfwd:auto:category-ai-chat-!cn" type=FWD name="ppl-ai-file-upload.s3.amazonaws.com" }
