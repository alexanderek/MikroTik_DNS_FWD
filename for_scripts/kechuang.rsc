...
:if ([:len [find name="kexinshe.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="dnsfwd:auto:kechuang" match-subdomain=yes type=FWD name="kexinshe.com" }
